...
(function initIntroScreen() {
  ...
  // Si llegamos desde otra página pulsando "Confirmar Asistencia"
  // (index.html#asistencia), saltamos la intro y abrimos el formulario:
  // obligar a abrir el sobre otra vez sería absurdo.
  if (window.location.hash === '#asistencia') {
    introScreen.style.display = 'none';
    document.body.style.overflow = '';
    setTimeout(() => { if (typeof openModal === 'function') openModal(); }, 200);
    return;
  }
