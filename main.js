...
(function initIntroScreen() {
  ...
  function openEnvelope() {
    ...
    // ── 3. Solapa abre (1.1s, termina ~1430ms) ───────────────────────
    setTimeout(() => {
      wrapper.classList.add('open');
      flapWrap.classList.add('opening');
    }, 320);

    // ── 4. Luz interior emerge con la solapa ─────────────────────────
    setTimeout(() => innerGlow.classList.add('glowing'), 490);

    // ── 5. Carta sube y se despliega (1.1s, termina ~1720ms) ─────────
    setTimeout(() => letterCard.classList.add('rising'), 620);

    // ── 6. Flash cinemático → fade (0.7s) ────────────────────────────
    setTimeout(() => introScreen.classList.add('dismissing'), 2100);

    // ── 7. Eliminar del DOM, desbloquear scroll ───────────────────────
    setTimeout(() => {
